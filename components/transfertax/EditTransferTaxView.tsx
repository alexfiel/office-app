...
import EditTransferTaxForm from "./EditTransferTaxForm"
import InvoicePreview from "@/components/invoice/invoice-preview"

export default function EditTransferTaxView({ initialData }: { initialData: any }) {
    ...
    return (
        <div className="flex-1 space-y-4 border rounded-lg p-4 bg-white shadow-sm">
            <EditTransferTaxForm initialData={initialData} onPreview={setPreviewData} />
        </div>
    )
}
