interface ReportSettlementFooterProps {
    userName: string;
}
export function ReportSettlementFooter({ userName }: ReportSettlementFooterProps) {
    return (
        <div className="grid grid-cols-2 gap-20 mt-16 text-sm">
            ...
            <div className="flex flex-col">
                ...
                <div className="border-b border-black pb-1">
                    <p className="font-bold uppercase text-center">HUBERT M. INAS, CPA, BCLTE</p>
                </div>
