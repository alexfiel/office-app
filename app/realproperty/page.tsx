    ...
    >
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col p-6 lg:p-10">
          <div className="mb-6">
            <h1 className="text-3xl font-bold tracking-tight">Real Property Details</h1>
            <p className="text-muted-foreground mt-2">Enter the new real property information.</p>
          </div>
